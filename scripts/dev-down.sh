...
stop_service "connector-backpressure-drafts" "$CONNECTOR_BACKPRESSURE_DRAFTS_PID_FILE"
stop_service "connector-guardian" "$CONNECTOR_GUARDIAN_PID_FILE"
stop_service "connector-redrive" "$CONNECTOR_REDRIVE_PID_FILE"
